...
export function MainLayout() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-x-clip bg-gradient-to-b from-emerald-50/60 via-stone-50/40 to-emerald-50/50">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <header className="fixed top-0 left-0 right-0 z-50 shadow-md bg-white w-full">
          <AnnouncementBar />
          <Navbar />
        </header>
        {/* Fixed Header Spacer to prevent page content overlap on mobile & desktop */}
        <div className="h-[84px] sm:h-[94px] shrink-0" aria-hidden="true" />
